...
Available permissions to configure:

```yaml
permissions:
  # Resource listing
  kubernetes-resources.resources.list:
    roles: ['admin', 'viewer']
    
  # Secret access
  kubernetes-resources.secrets.list:
    roles: ['admin']
  kubernetes-resources.secrets.view-yaml:
    roles: ['admin']
    
  # YAML viewing
  kubernetes-resources.yaml.view:
    roles: ['admin', 'viewer']
    
  # Event access
  kubernetes-resources.events.show:
    roles: ['admin', 'viewer']
    
  # Graph access
  kubernetes-resources.graph.show:
    roles: ['admin', 'viewer']
```
